...
export function TranscriptPanel() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="px-6 py-5 border-b border-gray-700 bg-gradient-to-r from-gray-800 to-gray-750">
        <div className="flex items-center justify-between">
          ...
          <div className="relative flex items-center gap-2">
            ...
            {menuOpen && (
              <div className="absolute right-0 top-7 z-50 w-44 bg-gray-800 border border-gray-700 rounded-lg shadow-xl overflow-hidden">
                <button
      ...
      {/* Transcript List */}
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3 bg-gray-850">
        {transcripts.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center px-4">
            <p className="text-gray-300 text-lg font-semibold mb-2">
              Waiting for transcripts…
          ...
          <>
            {transcripts.map((t, idx) => (
              <div
                key={idx}
                className="bg-gradient-to-br from-gray-700 to-gray-750 rounded-xl p-4 border border-gray-600"
              >
